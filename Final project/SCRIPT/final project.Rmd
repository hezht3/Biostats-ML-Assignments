...
I then checked the class and distribution of all variables:
...
I then drop observations with missing value in the outcome variable or in any predictors. The following results show the final data set used in model building:
