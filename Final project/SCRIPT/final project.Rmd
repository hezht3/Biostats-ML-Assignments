...
As shown from the output above, the model results in an accuracy of 81.7% and an AUC of 0.863, a relative high sensitivity of 94.8%, but a low specificity of 30.2%.
...
As shown from the output above, after balancing sensitivity and specificity, the model results in an accuracy of 80.2%, a sensitivity of 81.4%, a specificity of 75.5%, and an AUC of 0.863.
...
The random forests model do not show comparable performance with the logistic regression with regularization (lasso regression). I further try boosting trees model to increase the prediction performance.
...
As shown from the output above, the model results in an accuracy of 83.7% and an AUC of 0.861, a relative high sensitivity of 94.8%, but a low specificity of 39.6%.
...
As shown from the output above, after balancing sensitivity and specificity, the model results in an accuracy of 81.4%, a sensitivity of 83.3%, a specificity of 73.6%, and an AUC of 0.861.
